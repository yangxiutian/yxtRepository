...
//https://www.developer.com/java/other/article.php/1579071#Discussion%20and%20Sample%20Programs
...
public class AudioCapture02 extends JFrame{
  ...
  /**
	 * 
	 */
	private static final long serialVersionUID = -5431882998333887451L;
...
//      	                              getName() + ":" +new String(mixerInfo[cnt].
//      	                              getName().getBytes("ISO-8859-1"), "GBK"));
      }//end for loop
      ...
      Mixer mixer = AudioSystem.
                          getMixer(mixerInfo[4]);//原始：3   4（0~7）
      System.out.println(mixer.getMixerInfo().
                getName() + ":" +new String(mixer.getMixerInfo().
                getName().getBytes("ISO-8859-1"), "GBK"));
